...
const MAPBOX_TOKEN = 'pk.eyJ1IjoiYWRhcnNodHIiLCJhIjoiY2xmN3F0czg3MHRwazNzcGMwZHVrdnQ2MSJ9.Egne08IA6Lu64zYYGU9nQg'; // Set your mapbox token here`

const Styles = styled.div<SupersetPluginChartNavifyStylesProps>`
